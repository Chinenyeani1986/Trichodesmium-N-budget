...
a =Polys[2]@polygons[[1]]@Polygons[[1]]@coords # enclosed mackay-whisundays
...
d =Polys[8]@polygons[[1]]@Polygons[[1]]@coords # open mackay-whisundays
...
g =Polys[14]@polygons[[1]]@Polygons[[1]]@coords # midshelf mackay-whisundays
...
j =Polys[20]@polygons[[1]]@Polygons[[1]]@coords # offshore mackay-whisundays
...
#select central gbr coordinates
