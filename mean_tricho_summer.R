...
datapoly1 = map_ereefs_movie (var_name = c("Tricho_N"), 
...
datapol1 = map_ereefs_movie (var_name = c("Tricho_N"), 
...
datapoly <- datapoly1$datapoly
datapoly1 <- datapol1$datapoly

datapoly$value <- (datapoly$value +datapoly1$value) / 2

saveRDS(datapoly, file = "trichoN_summer.rds")
